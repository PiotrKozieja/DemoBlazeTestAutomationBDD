...
public class SignupTest extends BaseTest {
    ...
    public void testAllFieldsShouldBeFilledOutAlert(String username, String password){
    ...
    @Test(priority = 3,dataProvider = "accountDataProvider")
    public void testSuccesfulSignupPopUp(String username, String password){
